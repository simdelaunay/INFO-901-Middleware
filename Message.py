...
class MessageTo(Message):
    ...
    def __str__(self) -> str:
        return str(self.from_id) + " envoie à " + str(self.to_id) + " : " + self.object
...
class Token(MessageTo):
    ...
    def __str__(self) -> str:
        return str(self.from_id) + " envoie token à " + str(self.to_id) + " avec nbSync: " + str(
            self.nbSync) + " et tokenId: " + str(self.currentTokenId)
...
class AcknowledgementMessage(MessageTo):
    ...
    def __str__(self) -> str:
        return str(self.from_id) + " envoie accusé de réception à " + str(self.to_id)
...
class MessageToSync(MessageTo):
    ...
    def __str__(self) -> str:
        return str(self.from_id) + " envoie de manière synchrone à " + str(self.to_id) + " : " + self.object
...
class HeartbeatMessage(BroadcastMessage):
    ...
    def __str__(self) -> str:
        return str(self.from_id) + " envoie un Heartbeat"
...
class StartHeartbeatMessage(MessageTo):
    ...
    def __str__(self) -> str:
        return str(self.from_id) + " lance un Heartbeat"